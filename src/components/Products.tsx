...
const products = [{
  ...
  image: floatingCandleImg
}];
export const Products = () => {
  return <section id="products" className="section-padding bg-sage-soft/30">
      <div className="container mx-auto px-4 md:px-8">
        ...
        duration: 0.6
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-warm-brown mt-4 mb-6">המוצרים שלנו: </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {products.map((product, index) => <ProductCard key={product.name} {...product} delay={index * 0.1} />)}
        </div>
